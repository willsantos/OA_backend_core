...
namespace OA_Core.Repository.Repositories
{
    public class AlunoRepository : IAlunoRepository
    {
        ...
        public async Task AddAsync(Aluno aluno)
        {
            ...
            await _connection.ExecuteScalarAsync<string>(sql, new { id = aluno.Id, usuario_id = aluno.UsuarioId, data_criacao = aluno.DataCriacao, 
        ...
        public async Task EditAsync(Aluno aluno)
        {
            ...
            await _connection.ExecuteAsync(sql, new { id = aluno.Id, 
                usuario_id = aluno.UsuarioId,
                data_criacao = aluno.DataCriacao, 
                data_alteracao = aluno.DataAlteracao, 
                data_delecao = aluno.DataDelecao });
        }
